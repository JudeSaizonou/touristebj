    ...
    <div className="fixed inset-0 z-[9998] flex items-center justify-center" role="dialog" aria-modal="true">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl p-5 md:p-6 max-w-[calc(100%-2rem)] sm:max-w-md w-full mx-4 animate-scale-in">
        <div className="flex items-start gap-4">
          <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${iconStyles[variant]}`}>
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <button
            onClick={onConfirm}
            disabled={loading}
            className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors flex items-center gap-2 disabled:opacity-50 ${confirmStyles[variant]}`}
          >
