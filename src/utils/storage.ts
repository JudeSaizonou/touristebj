...
const DEFAULT_VOYAGES = [
  {
    ...
    politiqueRemboursement: 'Remboursement complet jusqu\'à 30 jours avant le départ. Remboursement de 30% entre 15 et 30 jours. Aucun remboursement moins de 15 jours avant le départ.',
    ceQuiEstInclus: [
